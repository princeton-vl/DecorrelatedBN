...
cmd:text()
cmd:text()
cmd:text('compare the Decorelated BatchNormalizaiton method with baselines on resnet architechture')
cmd:text()
cmd:text('Options')
...
torch.save('set_result/Conv/result_2residual_Cifar10_Now_'..baseString..'.dat',results)
end
