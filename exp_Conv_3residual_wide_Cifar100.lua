...
cmd:text()
cmd:text('Options')
cmd:option('-dataset','./dataset/cifar100_original.t7','')
...
cmd:option('-save',"log_exp_Cifar100_NoW" ,'subdirectory to save logs')
...
log_name='Cifar100_NoW_'..baseString
...
torch.save('set_result/Conv/result_3residual_Cifar100_Now_'..baseString..'.dat',results)
end
if opt.modelSave==1 then
  torch.save('SModel_Cifar100_NoW_'..baseString..'.t7', net:clearState())
end
