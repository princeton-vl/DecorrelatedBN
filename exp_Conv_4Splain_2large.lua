...
cmd:option('-epoch_step',"{60,100,140,180}",'epoch step: no lr annealing if it is larger than the maximum')
cmd:option('-save',"log_exp_4Splain_large" ,'subdirectory to save logs')
...
cmd:option('-learningRate',0.4,'initial learning rate')
...
cmd:option('-m_perGroup',14,'the number of per group')
...
torch.save('set_result/Conv/result_4Splain_large_'..opt.model..'_depth'..opt.depth
